...
export interface SwapServiceClient extends grpc.Client {
  /**
   * Read Domain
   */
...
export interface SwapServiceHandlers extends grpc.UntypedServiceImplementation {
  /**
   * Read Domain
   */
...
export interface SwapServiceDefinition extends grpc.ServiceDefinition {
